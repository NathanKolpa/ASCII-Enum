...
/* ENUMERATED TABLE OF ASCII CHARACTER CODES
 * Made by Nathan Kolpa
 * Modified by Joel Savitz
 */

#ifdef ASCII_EXTENDED
#define ASCII_EXPONENT 8
#else
#define ASCII_EXPONENT 7
#endif

#define ASCII_TABLE_SIZE 1 << ASCII_EXPONENT


enum ascii {
	/* IDENTIFIER		      *//*    DEPICTION/DESCRIPTION */
	 ...
	 * if you cant find a combination try switching the
